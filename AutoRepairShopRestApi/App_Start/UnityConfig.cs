...
namespace AutoRepairShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
           ...
           HierarchicalLifetimeManager());
            container.RegisterType<IGood, GoodServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<ISStock, SStockServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IMain, MainServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IReport, ReportServiceDB>(new
           HierarchicalLifetimeManager());
        }
    }
}