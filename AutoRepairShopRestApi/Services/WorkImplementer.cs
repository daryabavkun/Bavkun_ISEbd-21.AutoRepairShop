...
namespace AutoRepairShopRestApi.Services
{
    public class WorkImplementer
    {
        ...
        Thread myThread;
        public WorkImplementer(IMain service, IImplementer
       serviceImplementer, int implementerId, int orderId)
        {
            ...
            try
            {
                _service.TakeOrderInWork(new SOrderBinding
                {
                    Id = _orderId,
        ...
        public void Work()
        {
            try
            {
                ...
                // Типа выполняем
                Thread.Sleep(10000);
                _service.FinishOrder(new SOrderBinding
                {
                    Id = _orderId
                });
            }
