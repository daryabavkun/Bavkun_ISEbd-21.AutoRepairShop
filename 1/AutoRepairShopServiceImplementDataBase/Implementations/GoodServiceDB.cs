...
{
    public class GoodServiceDB : IGood
    {
        private AutoRepairShopDbContext context;
        public GoodServiceDB(AutoRepairShopDbContext context)
        {
        ...
        public List<GoodView> GetList()
        {
           ...
           GoodView
            {
                ...
                Price = rec.Price,
                ProductComponent = context.ProductComponents
           ...
           .Select(recPC => new GoodComponentView
           {
               ...
               ComponentName = recPC.SComponent.ComponentName,
               Count = recPC.Count
           })
           .ToList()
            })
