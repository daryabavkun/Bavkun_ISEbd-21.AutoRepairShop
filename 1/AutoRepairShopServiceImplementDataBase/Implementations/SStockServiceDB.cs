...
{
    public class SStockServiceDB : ISStock
    {
        private AutoRepairShopDbContext context;
        public SStockServiceDB(AutoRepairShopDbContext context)
        {
            this.context = context;
        }
        public List<SStockView> GetList()
        {
            List<SStockView> result = context.Stocks.Select(rec => new
           SStockView
            {
                Id = rec.Id,
        ...
        {
            SStock element = context.Stocks.FirstOrDefault(rec => rec.StockName ==
           model.StockName);
            if (element != null)
            {
